...
def draw_gt_boxes3d(gt_boxes3d, fig, color=(1, 1, 1), line_width=1, draw_text=False, scores=None, text_scale=(1, 1, 1),
                    color_list=None, show=False):
    ...
    for n in range(num):
        ...
        if scores is not None: mlab.text3d(b[4, 0], b[4, 1], b[4, 2], '%02f' % scores[n], scale=(.25, .25, .25),
